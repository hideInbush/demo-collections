...
var data = {
    ...
    chineseWidth: '',
    expandFlag: false,
    replies: [{ fromUser: '马庆忠', toUser: '', content: '感谢留言，您遇到的问题我们已经通过，正在尽快处理中，请期待下次版本的更新！感谢留言，您遇到的问题我们已经通过，正在尽快处理中，请期待下次版本的更新！感谢留言，您遇到的问题我们已经通过，正在尽快处理中，请期待下次版本的更新！感谢留言，您遇到的问题我们已经通过，正在尽快处理中，请期待下次版本的更新！感谢留言，您遇到的问题我们已经通过，正在尽快处理中，请期待下次版本的更新！感谢留言，您遇到的问题我们已经通过，正在尽快处理中，请期待下次版本的更新！', time: '2018.3.2 15:36' }, { fromUser: 'Poinfy', toUser: '马庆忠', content: '很高兴意见被采纳，期待版本更新。', time: '2018.3.2 15:36' }, { fromUser: '马庆忠', toUser: 'Poinfy', content: '版本已经更新完成，欢迎踊跃提议！', time: '2018.3.2 15:36' }]
};

_reactDom2.default.render(_react2.default.createElement(_comment2.default, { data: data }), document.getElementById('root'));
...
var Comment = function (_React$Component) {
    ...
    _createClass(Comment, [{
        ...
        value: function componentDidMount() {
            ...
            replies.map(function (v) {
                var containerW = document.querySelector('.comment-reply').querySelector('p').offsetWidth;

                v.ellipsisContent = _this2.ellipsisText(containerW, 2, v.content);
                v.expandFlag = false;
            });
        ...
        key: 'calculateCharWidth',
        value: function calculateCharWidth(char) {
            /**
             * 计算单个字符的宽度
             */
        ...
        key: 'ellipsisText',
        value: function ellipsisText(containerW, lineNum, text) {
        ...
        key: 'viewDetailComment',
        value: function viewDetailComment() {
        ...
        key: 'viewDetailReply',
        value: function viewDetailReply(event, index) {
            var replies = this.state.replies;
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'comment-stu' },
                    _react2.default.createElement('input', { type: 'checkbox' }),
                    this.state.ellipsisCommentText ? this.state.expandFlag ? _react2.default.createElement(
                        'span',
                        { className: 'test' },
                        ...
                        _react2.default.createElement(
                            ...
                            { onClick: function onClick() {
                                    return _this3.viewDetailComment();
                                }, className: 'btn-more' },
                            ' \u6536\u8D77\u66F4\u591A'
                        )
                    ) : _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    this.state.replies.map(function (v, i) {
                        return i == 0 ? _react2.default.createElement(
                            'div',
                            { key: i },
                            v.ellipsisContent ? _react2.default.createElement(
                                'p',
                                null,
                                _react2.default.createElement(
                                    'span',
                                ...
                                _react2.default.createElement(
                                    'a',
                                    { onClick: function onClick() {
                                            return _this3.viewDetailReply(event, i);
                                        }, className: 'btn-more' },
                                    v.expandFlag ? ' 收起更多' : ' 查看更多'
                                )
                            ) : _react2.default.createElement(
                                'p',
                                null,
